...
public class EnvironmentVarView extends JFrame {
    ...
    public void positionUI() {
        ...
        addVariableChanger("Oxygen level", 10, 0, 100, environmentOxygenLevel, 6);
        addVariableChanger("Toxicity", 1, 0, 8, environmentToxicityLevel, 7);
        addVariableChanger("Food level", 50, 0, 500, foodLevel, 8);
            ...
            public void stateChanged(ChangeEvent e) {
                switch (valueToChange) {
                    ...
                    case 5:
                        ...
                        System.out.println("Passing radiation value of " + slider.getValue());
                        break;
                    case 6:
    ...
    public void generateTemplate() {
        ...
        environmentTemplate[7] = foodLevel;
